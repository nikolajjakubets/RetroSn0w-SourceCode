...
- (IBAction)recoveryaction:(id)sender {
    system("chmod +x ~/Documents/RetroSn0w/make.sh; /Applications/Utilities/Terminal.app/Contents/MacOS/Terminal ~/Documents/RetroSn0w/make.sh");
    system("killall Terminal");
}
- (IBAction)autoboot:(id)sender {
    system("chmod +x ~/Documents/RetroSn0w/restorerun.sh; /Applications/Utilities/Terminal.app/Contents/MacOS/Terminal ~/Documents/RetroSn0w/restorerun.sh");
}
...
- (IBAction)removeinstall:(id)sender {
